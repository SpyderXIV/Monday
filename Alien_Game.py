...
#This will be reapated throughout the rest of the code, which if the health variable ever reaches 0, the game will be over
if health == 0:
...
while attempts == True:
    ...
    if choice2 == "A" and pClass == "2":
        ...
        break
    elif choice2 == "A" and pClass == "1" or pClass== "3":
...
while attempts == True:
    ...
    if choice7 == "A":
        ...
        print(f"You burst out the front door of the town hall, ready for action. You run down the block and round the corner to see a large portion of the Legion’s army. They immediately charge you and overwhelm you in an instant. Your {weapon} was useless against them.")
        health = 0
        break
    elif choice7 == "C":
        print(f"You walk around the town hall and eventually stumble upon the weaponsmith. He greets you and says “What can I do for you today my friend?”, “I’m in desperate need of an upgrade”, you responded, “I couldn’t have guessed”, he responded sarcastically. You hand over your {weapon} and he turns it into:")
        if choice1 == "Plate":
...
while attempts == True:
    ...
    if choice8 == "A":
        ...
        health = 0
        break
    elif choice8 == "A" and pClass == "Citizen":
        print("You run head-on at the wall of aliens, which is suicide, but somehow, you defy all laws of nature, jumping 20 feet into the sky and taking out every alien one by one with your bare fists. (ACHIEVEMENT UNLOCKED: I’m him.)")
    elif choice8 == "B":
        print("You run away as fast as you can, and manage to duck behind a destroyed phone booth without being seen.")
        break
